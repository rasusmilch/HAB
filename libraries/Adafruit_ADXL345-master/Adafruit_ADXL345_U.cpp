...
bool Adafruit_ADXL345_Unified::getEvent(sensors_event_t *event) {
  ...
  event->timestamp = 0;
  event->acceleration.x = getX() * ADXL345_MG2G_MULTIPLIER * SENSORS_GRAVITY_STANDARD * correction;
  event->acceleration.y = getY() * ADXL345_MG2G_MULTIPLIER * SENSORS_GRAVITY_STANDARD * correction;
  event->acceleration.z = getZ() * ADXL345_MG2G_MULTIPLIER * SENSORS_GRAVITY_STANDARD * correction;
...
void Adafruit_ADXL345_Unified::setCorrection(double correction_value) {
